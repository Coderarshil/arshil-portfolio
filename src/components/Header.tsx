...
export function Header() {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 z-[80] transition-all duration-500 ease-in-out ${scrolled ? 'bg-[var(--bg-primary)]/90 backdrop-blur-md shadow-sm border-b border-[var(--border-color)]/50 py-3' : 'bg-transparent py-4 lg:py-5'}`}>
