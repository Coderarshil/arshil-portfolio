  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-[var(--bg-primary)]/85 backdrop-blur-xl border-t border-[var(--border-color)]/20 pb-safe z-50 shadow-[0_-8px_30px_rgba(0,0,0,0.04)]">
      <div className="flex items-center justify-around h-16">
        ...
        <button onClick={() => go('#projects')} className="relative -top-5 flex items-center justify-center w-14 h-14 bg-[var(--accent-primary)] rounded-full text-white shadow-xl active:scale-95 border-2 border-[var(--bg-primary)]/65" aria-label="Projects">
          <Coffee size={23} />
        </button>
